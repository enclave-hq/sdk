...
async function testKMSGenerateKey() {
    ...
    try {
        ...
        if (generateResponse.data.success) {
            ...
            console.log(`  🔐 加密密钥: ${generateResponse.data.encrypted_key.slice(0, 20)}...`);
            ...
            const signRequest = {
                ...
                data_to_sign: '0x1234567890abcdef1234567890abcdef1234567890abcdef1234567890abcdef',
                chain_id: 56,
                tx_hash: '0xabcdef123456789abcdef123456789abcdef123456789abcdef123456789abcdef'
            };
            ...
            const foundKey = keysResponse.data.keys.find(k => k.key_alias === keyAlias);
